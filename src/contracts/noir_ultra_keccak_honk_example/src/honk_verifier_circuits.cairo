...
pub fn run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_5_circuit(
    ...
    let t4 = circuit_sub(in53, in51);
    let t5 = circuit_inverse(t4);
    let t6 = circuit_add(in53, in51);
    let t7 = circuit_inverse(t6);
    let t8 = circuit_add(in53, t0);
    let t9 = circuit_inverse(t8);
    let t10 = circuit_add(in53, t1);
    let t11 = circuit_inverse(t10);
    let t12 = circuit_add(in53, t2);
    let t13 = circuit_inverse(t12);
    let t14 = circuit_add(in53, t3);
    let t15 = circuit_inverse(t14);
    let t16 = circuit_mul(in54, t7);
    let t17 = circuit_add(t5, t16);
    let t18 = circuit_sub(in0, t17);
    let t19 = circuit_inverse(in51);
    let t20 = circuit_mul(in54, t7);
    ...
    circuit_inputs = circuit_inputs.next_2(tp_gemini_r); // in51
    circuit_inputs = circuit_inputs.next_2(tp_rho); // in52
    circuit_inputs = circuit_inputs.next_2(tp_shplonk_z); // in53
    circuit_inputs = circuit_inputs.next_2(tp_shplonk_nu); // in54
    ...
    let scalar_22: u384 = outputs.get_output(t274);
    let scalar_23: u384 = outputs.get_output(t275);
    let scalar_24: u384 = outputs.get_output(t276);
    let scalar_25: u384 = outputs.get_output(t277);
    let scalar_26: u384 = outputs.get_output(t124);
    let scalar_27: u384 = outputs.get_output(t128);
    let scalar_28: u384 = outputs.get_output(t278);
    let scalar_29: u384 = outputs.get_output(t279);
    let scalar_30: u384 = outputs.get_output(t280);
    let scalar_31: u384 = outputs.get_output(t281);
    ...
    let scalar_72: u384 = outputs.get_output(t273);
    let sum_scalars: u384 = outputs.get_output(t321);
    return (
        scalar_1,
        scalar_2,
        scalar_3,
